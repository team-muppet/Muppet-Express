<script>
  ...
  let { title = "Make API Call", endpoint = "/api/example", headers = { "Content-Type": "application/json" }, body = { hello: "world" } } = $props();
...
<div class="card p-4 text-left space-y-4">
  ...
  <TabGroup>
    <Tab bind:group={tabSet} name="tabRequest" value={0}>
    ...
    <Tab bind:group={tabSet} name="tabResponse" value={1}>
      <div class="flex items-start">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <div class="mt-2" style="height: 200px;">
              <JSONEditor mode="text" mainMenuBar={false} statusBar={false} navigationBar={false} content={{ json: body }} on:change={handleBodyChange} />
            </div>
          </div>
